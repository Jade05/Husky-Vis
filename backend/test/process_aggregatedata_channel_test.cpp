...
int main (int argc, char** argv) {
    ...
    std::vector<husky::visualization::SuggestionObject> rawdata_suggestions = process_rawdata_channel_test.get_rawdata_suggestions();
    ...
    std::vector<husky::visualization::SuggestionObject> aggregatedata_suggestions = process_aggregatedata_channel_test.get_aggregatedata_suggestions();

    // output
    for (std::vector<husky::visualization::SuggestionObject>::iterator item = aggregatedata_suggestions.begin(); item != aggregatedata_suggestions.end(); item++) {
        cout << *item;
    }
