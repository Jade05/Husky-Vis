...
public:
     ...
     */
     ...
     static husky::visualization::BaseObj calculate_scores(husky::visualization::BaseObj& suggestion, husky::visualization::Constant constant) {
      ...
      for (int i = 0; i < aggregate_data.size(); i++) {
        statistic_data.push_back(aggregate_data[i].second());
      }
      // temporary score calculate method
      statistic_method_score = Utils::map_function[statistical_method](statistic_data);
